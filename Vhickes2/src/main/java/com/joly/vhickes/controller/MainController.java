...
import com.joly.vhickes.model.mappers.VehicleMapper;
...
public class MainController {
    ...
    private void showStopModal() {
        if (showStatisticProperty.get()) {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(HabitatInfoController.class.getResource("/com/joly/vhickes/fxml/habitat-info-view.fxml"));
    ...
    public void handleAbout() {
        final Stage dialog = new Stage();
        FXMLLoader fxmlLoader = new FXMLLoader(MenuAboutController.class.getResource("/com/joly/vhickes/fxml/menu-about-view.fxml"));
